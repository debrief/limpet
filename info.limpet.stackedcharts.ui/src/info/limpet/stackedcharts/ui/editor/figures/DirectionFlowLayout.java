...
public class DirectionFlowLayout extends FlowLayout
{
  ...
  /**
   * The property that determines whether leftover space at the end of a row/column should be filled
   * by the last item in that row/column.
   * 
   ...
   * 
   * @deprecated Use {@link #getMajorAlignment()} and {@link #setMajorAlignment(int)} instead.
   */
   ...
   * 
   * @deprecated Use {@link #getMajorSpacing()} and {@link #setMajorSpacing(int)} instead.
   */
   ...
   * 
   * @deprecated Use {@link #getMinorSpacing()} and {@link #setMinorSpacing(int)} instead.
   */
   ...
   * @since 2.0
   */
  public DirectionFlowLayout(boolean isHorizontal)
  {
  ...
  /**
   * Returns the spacing in pixels to be used between children in the direction parallel to the
  ...
  /**
   * Layouts one row of components. This is done based on the layout's orientation, minor alignment
   * and major alignment.
   * 
   * @param parent
   *          the parent figure
