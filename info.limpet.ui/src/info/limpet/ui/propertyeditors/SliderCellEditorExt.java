...
/**
 * A copy of the {@link SliderCellEditor} class, dealing with Integer instead of String values
 * 
 */
public class SliderCellEditorExt extends CellEditor
{
  ...
  public SliderCellEditorExt(final Composite parent, int minValue, int maxValue)
  {
  ...
  protected void doSetValue(final Object value)
  {
    ...
    if (_myLabel != null)
    {
      _myLabel.setText(formatMe(intValue));
    }
    if (_theSlider != null)
    {
      ...
      _theSlider.setSelection(intValue);
