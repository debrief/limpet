...
public class TestCollections extends TestCase
{
  ...
  public void testAddQuantityTemporalInterp()
  {
    IndexedNumberDocumentBuilder tqb1 =
        new IndexedNumberDocumentBuilder("Some data1", METRE.divide(SECOND).asType(Velocity.class), null);
    tqb1.add(100, 10);
    tqb1.add(200, 20);
    tqb1.add(300, 30);
    tqb1.add(400, 40);
    ...
    IndexedNumberDocumentBuilder tqb2 =
        new IndexedNumberDocumentBuilder("Some data2", METRE.divide(SECOND).asType(Velocity.class), null);
    tqb2.add(220, 11);
    tqb2.add(340, 17);
    tqb2.add(440, 22);
    ...
    Document series =
        (Document) store.get("Sum of Some data1, Some data2");
