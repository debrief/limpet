...
public class ReflectivePropertySource implements IPropertySource
{
	...
	try
	{
		PropertyDescriptor[] beanPropertyDescriptors = Introspector
	...
	catch (IntrospectionException e)
	{
		Activator.logError(Status.ERROR,
			"Could not load property descriptors for class " + cls.getName(),
			e);
	...
	{
		Activator.logError(Status.ERROR,
			"Could not retrive value for property " + id, e);
		return null;
	}
	}
