...
public class ApplicationWorkbenchWindowAdvisor extends WorkbenchWindowAdvisor
{
  ...
  private static final String WELCOME_EDITOR_ID =
      "org.eclipse.ui.internal.ide.dialogs.WelcomeEditor"; //$NON-NLS-1$
   ...
   * 
   * @see
   * org.eclipse.ui.application.WorkbenchWindowAdvisor#createActionBarAdvisor(org.eclipse.ui.application
  ...
  /**
   * Asks the user whether the workbench should really be closed. Only asks if the preference is
   * enabled.
   * 
   * @param parentShell
  ...
  static boolean promptOnExit(Shell parentShell)
  {
    ...
    if (promptOnExit)
    {
      ...
      {
        message =
            NLS.bind(IDEWorkbenchMessages.PromptOnExitDialog_message1,
                productName);
      }
      ...
      MessageDialogWithToggle dlg =
          MessageDialogWithToggle
              .openOkCancelConfirm(parentShell,
                  ...
                  IDEWorkbenchMessages.PromptOnExitDialog_choice, false, null,
                  null);
      ...
      WelcomeEditorInput input, String perspectiveId)
  {
    ...
    if (perspectiveId != null)
    {
      ...
      {
        win =
            getWorkbench().openWorkbenchWindow(perspectiveId,
   ...
   * 
   * @see
   * org.eclipse.ui.application.WorkbenchAdvisor#createEmptyWindowContents(org.eclipse.ui.application
   * .IWorkbenchWindowConfigurer, org.eclipse.swt.widgets.Composite)
   */
